...
![Version: 2025.7.5](https://img.shields.io/badge/Version-2025.7.5-informational?style=flat-square)
...
| prometheus.image.tag | string | `"v2.55.1"` | Docker image tag for the prometheus instance |
